...
<template>
	<div class="products">
		<div class="products-section" v-for="(_, productCategory) in products">
...
<style lang="scss" scoped>
 .products {
	 ...
	 &-list {
		 @apply flex md:grid grid-cols-1 gap-10 md:grid-cols-4 max-w-full flex-col md:flex-row px-6 md:px-0;
	 }
 }
</style>
